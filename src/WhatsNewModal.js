...
const 最後に配信した版 = '2026-09-14-02';
// お知らせの版。新しい項目を足したら、必ずこれを最新の項目の 版 に合わせる。
const NOTICE_VERSION = '2026-09-14-03';
...
const NOTICE_ITEMS = [
  ...
  },
  {
    ...
    points: [
      ...
      'AIチャットで、道具を使う質問（記録の集計など）がエラーになるのと、打った名前が二重になるのを直しました。',
      '写真の読み取りで、板の罫線が濃いときや列の数を数え間違えるときの読み取りを直しました。',
      'AIの鍵をアプリの中に置かず、中継を通して使う形にしました（使い方は変わりません）。',
    ],
  },
  {
    date: '2026/09/13',
