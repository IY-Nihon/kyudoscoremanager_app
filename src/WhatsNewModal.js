...
const NOTICE_ITEMS = [
  ...
  },
  {
    date: '2026/09/09',
    版: '2026-09-09-01',
    title: '個人ログインの画面を作り直しました',
    points: [
      'メンバーのタブが個人ログインでも出るようになり、自分の弓具をご自分で残せます。',
      '「自分の情報」に、自分の記録と弓具の履歴だけを並べました。',
  ...
  },
  {
    date: '2026/09/09',
    版: '2026-09-09-01',
    title: '記録表を横にしたときも、同じように使えます',
    points: [
      '「横へ」で横に並べたときも、チームの色・立ち順の入れ替えが使えるようにしました。',
      '過去の記録表の詳細でも、縦と横を切り替えられます。',
    ],
  },
  {
    date: '2026/09/09',
