...
const 最後に配信した版 = '2026-09-17-01';
// お知らせの版。新しい項目を足したら、必ずこれを最新の項目の 版 に合わせる。
const NOTICE_VERSION = '2026-09-17-01';
...
const NOTICE_ITEMS = [
  {
    ...
    points: [
      ...
      '直し終えたら「保存して戻る」で元の記録に書き戻します。「やめる」なら何も変わりません。直している間、いま記録中だった記録表は控えに取り、戻ると元どおりになります。',
      '三本線の窓の「人追加・間隔追加・計追加」は記録画面で足せるので外し、「記録を編集」は「記録の情報を変える（日付・題・メモ・タグ・出欠）」に改めました。',
      'タグを画面に出すとき、先頭の # を付けないようにしました。',
    ],
  },
  {
    date: '2026/09/15',
