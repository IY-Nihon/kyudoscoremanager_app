...
// ─────────────────────────────────────────
// いま本番に出ている版。配信したら NOTICE_VERSION に合わせて更新する。
// これより新しい項目があるのに版を上げ忘れると、足したお知らせが
// 「今後表示しない」を押した人に二度と出ない（2026-08-28 に踏んだ）。
// 「配信済みの版のまま項目を足していない」ことは test/autoLock.test.js が、
// 「NOTICE_VERSION が最新の項目と一致し、形がそろっている」ことは
// test/updateNotice.test.js が見張っている。
const 最後に配信した版 = '2026-09-09-01';
// お知らせの版。新しい項目を足したら、必ずこれを最新の項目の 版 に合わせる。
const NOTICE_VERSION = '2026-09-12-01';
...
const NOTICE_ITEMS = [
  {
    date: '2026/09/12',
    版: '2026-09-12-01',
    title: '写真からの読み取りが、ずっと正確になりました',
    points: [
      'ホワイトボードと紙の○×を、端末の中で読むようにしました。丸に引いた線の向き（1本目と2本目のどちらが中ったか）も読めます。',
      '写真は1枚に板が2つ写っていても、2枚に分けて撮っても読めます。1射目はいちばん下のマス（横書きの紙は左端）として読みます。',
      '読み取りが迷ったマスは、確認画面で黄色い枠になります。押して直してください。',
      '氏名は名簿と照らし合わせて決めます。相手校など名簿に無い人は、部員に化けずゲストのままになります。',
      '読み取った人はいまの記録表の後ろに足され、射数は写真と記録表で多いほうに合わせます。',
    ],
  },
  {
    date: '2026/09/12',
    版: '2026-09-12-01',
    title: '団体アカウントを、設定から削除できます',
    points: [
      '設定の「管理者設定」で管理者モードをオンにすると、「アカウント」に「アカウントを削除する」が出ます。',
      '団体パスワードを入れて削除すると、記録・部員・卒業生・設定がすべて消え、団体IDでログインできなくなります。',
      '削除後30日間は運営者が復旧のために保管し、その後に消去します。必要な記録は先に「データ管理」から書き出してください。',
    ],
  },
  {
    date: '2026/09/12',
    版: '2026-09-12-01',
    title: 'AIチャットボットに、頼める操作の例を足しました',
    points: [
      '質問例に「新しい部員を追加して」「分析の画面を開いて」などが出ます。部員の追加は、確認のカードを押してから登録されます。',
      '団体アカウントの削除の仕方も答えられます。',
    ],
  },
  {
    date: '2026/09/12',
    ...
    title: '不具合の直し',
    points: [
      '30日より前の記録が、履歴から突然消えて見えることがあったのを直しました（クラウドには残っていました）。',
    ],
  },
  {
    date: '2026/09/09',
    ...
    title: '立ち順を、入れ替えられます',
    points: [
      '記録表の名前のところを長押しすると、その列を掴めます。',
      'そのまま指をすべらせると、離した所へ入ります。○×も矢所も一緒に移ります。',
      '名前を押して出る窓の「右へ動かす」「左へ動かす」でも、1つずつ動かせます（横に並べているときは「上へ」「下へ」）。',
      '取り消しで元に戻せます。ライブ中は相手の画面にも並びが届きます。',
    ],
  },
  {
    date: '2026/09/09',
    版: '2026-09-09-01',
    title: '区切りにチーム名を付けて、色で分けられます',
    points: [
      '記録表の区切り（間隔）を押すと窓が出て、「チーム名を付ける」から大学名などを入れられます。',
      '付けた名前より左の射手に、チームの色が付きます。リーグや練習試合で見分けやすくなります。',
      '保存した記録の詳細でも、チーム名と色が出ます。',
    ],
  },
  {
    date: '2026/09/09',
    版: '2026-09-09-01',
    title: '「総計」で、立ちをまとめて数えられます',
    points: [
      '「計」を入れたあと、その列を押すと「手前の計もまとめた総計にする」を選べます。',
      '立ちごとに「計」を置き、その端に「総計」を置くと、まとめた数が出ます。',
      '間隔（区切り）を入れると、そこが総計の切れ目になります。',
    ],
  },
  {
    date: '2026/09/09',
    版: '2026-09-09-01',
    title: '個人ログインでも、自分の弓具を残せます',
    points: [
      '個人（部員）で入ったときにも「メンバー」のタブが出るようになりました。',
      '「自分の情報」に自分のことだけが並び、弓力や弦を変えたらその場で足せます。分析で前後の的中を比べられます。',
      '氏名・性別・学年・期は団体の担当者が直します（見るだけです）。',
    ],
  },
  {
    date: '2026/09/09',
    版: '2026-09-09-01',
    title: 'Google のアカウントでも団体を作れます',
    points: [
      '団体アカウントを作るとき、Google のアカウントでも登録できるようにしました。',
      'メンバーを選ぶときに、男子・女子で絞れるようにしました。男女別の立ちを組むときに使ってください。',
    ],
  },
  {
    date: '2026/09/09',
    ...
    title: '不具合の直し',
    points: [
      '弓具の「履歴を追加」を押しても何も起きなかったのを直しました。',
      '矢所の窓が、押しただけで閉じてしまうのを直しました。置いた場所を見て、その場で置き直せます。',
      '月が多いとき、月のボタンがつぶれて字が折り返すのを直しました。',
      '分析の比較で、長い名前に的中率が重なるのを直しました。比較中も的中の型と全体の的中率が出ます。',
      'アプリを2つ以上開いていると、あとから開いた方でクラウドとの同期が止まることがあったのを直しました。「複数のタブで開かれているため…」の帯も出なくなります。',
      'お知らせ・分析・出欠の窓は、外側を押しても閉じられるようにしました。',
    ],
  },
  {
    date: '2026/09/05',
  ...
  },
  {
    ...
    title: 'ライブをリンクで配れます',
    points: [
      '青い帯から、編集用と閲覧用のリンクを作れます。合言葉と有効期限を付けられます。',
      'リンクを渡した相手には、記録中の的中・氏名・立ち順が見えます。',
    ],
  },
  {
    date: '2026/08/31',
  ...
  },
  {
    date: '2026/08/31',
    版: '2026-08-28-02',
    title: 'ライブ記録の安全性を高めました',
    points: [
      '置き場所を、ほかの団体から辿れない仕組みに変えました。',
      '更新の瞬間に行っているライブは切れます。お手数ですが始め直してください。',
    ],
  },
  {
    date: '2026/08/31',
