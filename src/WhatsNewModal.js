...
const NOTICE_ITEMS = [
  ...
  },
  {
    ...
    title: '細かい直し',
    points: [
      '矢所を押したとき、置いた場所がその場に残るようにしました。離す前に確かめられます。',
      '分析と出欠の詳しい窓は、外側を押しても閉じられるようにしました。',
      '個人ログインで分析を開くと画面が止まることがあったのを直しました。',
      'メンバーを選ぶときに、男子・女子で絞れるようにしました。',
      'Google のアカウントでも、団体アカウントを作れるようにしました。',
    ],
  },
  {
    date: '2026/09/05',
