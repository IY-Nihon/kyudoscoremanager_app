...
const NOTICE_VERSION = '2026-09-14-02';
...
const NOTICE_ITEMS = [
  {
    date: '2026/09/14',
    版: '2026-09-14-02',
    title: '写真からの読み取りが、相手校の板でも使えるようになりました',
    points: [
      '印がマスいっぱいに書かれた板（試合相手の板など）は、AIに○×の範囲だけを聞いて、中を端末で読みます。これまで6割ほどだった読み取りが、9割台になりました。',
      '板が2つ写った写真で、片方の板が細かく分かれて区切りと計が余計に入ることがあったのを直しました。',
      '写真には列があるのにAIが人を落としたときは、確認画面にその旨が出ます。名札の無い人がいたら、記録表で足してください。',
    ],
  },
  {
    date: '2026/09/14',
