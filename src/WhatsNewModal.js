...
const NOTICE_VERSION = '2026-09-26-03';
...
const NOTICE_ITEMS = [
  {
    date: '2026/09/26',
    版: '2026-09-26-03',
    title: 'AIチャットと読み取りで送った内容を、アプリの改善のため1年間保存します',
    points: [
      'AIチャットの質問と答え、写真の読み取り・出欠の予定表のスキャンで送った写真やファイル（写っている名前も含みます）と読み取った結果を、1年間保存します。読み取った結果を使わなかったときも保存します。',
      '保存したものは運営者だけが見て、読み取りやAIチャットをよくするために使います。設定の「利用規約・プライバシーポリシー」に書き足しました。',
    ],
  },
  {
    date: '2026/09/26',
