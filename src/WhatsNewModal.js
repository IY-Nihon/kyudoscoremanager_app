...
const NOTICE_VERSION = '2026-09-19-02';
...
const NOTICE_ITEMS = [
  {
    date: '2026/09/19',
    版: '2026-09-19-02',
    title: 'パソコンで、タグの並びをマウスの車で横に動かせるようになりました',
    points: [
      '終了・保存のタグの定型文、履歴と分析のタグ、履歴の月の並びは横に流れます。マウスの車は上下にしか回らず動かせなかったので、並びの上で回したときは横に読み替えるようにしました。端まで来たら、ふつうの上下のスクロールに戻ります。',
    ],
  },
  {
    date: '2026/09/19',
