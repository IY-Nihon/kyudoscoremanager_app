...
const NOTICE_ITEMS = [
  {
    ...
    points: [
      '記録画面の読み上げとAIチャットの射位（大前・落など）は、区切りごとに数え直します。以前は2枚目の板の先頭が「5番」になっていました。',
    ],
  },
  {
    date: '2026/09/20',
    ...
    points: [
      '出席率は出欠画面と同じく、正規練習日ごとに「記録に出ていれば来た」で数えます。以前は記録に付けた出欠だけを数えていたため、9月に記録が2件しかないと全員「2回・100%」と答えていました。',
      '「9月の成績」のような期間で、月初の朝9時より前の記録が落ちていたのを直しました。',
      '同じ姓の部員が2人いるときは聞き返します。「永井」のように短く聞いても射位ごとの成績が出ます。',
  ...
  },
  {
    ...
    points: [
      'アイコンの字体を端末に控えておき、読めなかったときは自動で読み直します。2回目からは起動も速くなります。',
    ],
  },
  {
    date: '2026/09/20',
    ...
    points: ['自校の板で、線の薄い「丸に線」や小さな×を読み違えることがありました。'],
  },
  {
    date: '2026/09/20',
    版: '2026-09-20-05',
