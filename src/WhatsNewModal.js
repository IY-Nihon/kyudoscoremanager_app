...
const NOTICE_VERSION = '2026-09-24-04';
...
const NOTICE_ITEMS = [
  {
    ...
    points: ['iPad や Android でホーム画面に追加したときも、端末に合った大きさと形でアイコンが出ます。'],
  },
  {
    date: '2026/09/24',
    版: '2026-09-24-03',
    title: 'パスワードの再設定などのメールが、日本語で届くようになりました',
    points: ['差出人は「弓道部的中ノート」です。届いたメールに返信すると、運営者に届きます。'],
  },
  {
    date: '2026/09/24',
    版: '2026-09-24-02',
    title: '団体アカウントのログインに使うメールアドレスを変えられるようにしました',
    points: [
  ...
  },
  {
    date: '2026/09/24',
    版: '2026-09-24-01',
    title: '登録のときに入れた団体名が、設定と部員の画面に出るようにしました',
    points: ['団体名を付け直していない団体では、「未設定」と出ていました。'],
  },
  {
    date: '2026/09/20',
    版: '2026-09-20-09',
