...
const NOTICE_VERSION = '2026-09-20-05';
...
const NOTICE_ITEMS = [
  {
    ...
    points: [
      '白いチョークの黒板は明るさを裏返して読みます。小計の列が無く空の列で人を区切った板、印がマスいっぱいの板、灰色の細いペンの線でも、切り抜きが外れにくくなりました。',
      'AI が混み合っていて読めなかったとき、「画像の解析に失敗しました」ではなく「混み合っています」と出します。裏では少し待って 2 回まで送り直します。',
    ],
  },
  {
    date: '2026/09/20',
