...
const NOTICE_ITEMS = [
  ...
  },
  {
    date: '2026/09/26',
    版: '2026-09-26-04',
    title: '画面の大きさによって、履歴の記録が出ないことがあったのを直しました',
    points: [
      '画面の幅や高さによっては、検索やタグの欄で画面がいっぱいになり、記録の一覧が出ていませんでした。いまは一覧と一緒に流れます。',
      'メンバーの編集・射数・表示の大きさの窓も、画面に収まらないときは流せるようにしました。下の「保存する」などに届かないことがありました。',
    ],
  },
  {
    date: '2026/09/26',
