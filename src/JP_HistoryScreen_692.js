...
const _a = typeof id !== 'undefined' ? id : 692;
const m = module;
const _e = exports;
...
(Object.defineProperty(_e, '__esModule', { value: !0 }),
  Object.defineProperty(_e, 'HistoryScreen', {
    enumerable: !0,
    get: function () {
      return D;
    },
...
const v = () => (0, k.jsx)(o.default, { style: { height: 1, backgroundColor: '#E5E5EA', marginLeft: 16 } }),
  D = () => {
    const {
        ...
        setAdminMode: O,
        historyViewMode: M,
        setHistoryViewMode: H,
        selectedHistorySessionId: P,
        setSelectedHistorySessionId: L,
        viewScale: V,
        deleteArcher: $,
        deleteSession: N,
        deleteMultipleSessions: _,
        restoreSession: G,
        emptyTrash: Y,
        updateSession: U,
        isHydrated: q = !1,
        historySelectedTags: J,
        historyTagLogic: K = 'AND',
        setHistorySelectedTags: Q,
        toggleHistoryTag: X,
      ...
      [ue, he] = (0, t.useState)(new Set()),
      [ge, fe] = (0, t.useState)(!1),
      [me, xe] = (0, t.useState)(!1),
      [ye, be] = (0, t.useState)(new Set()),
      [pe, je] = (0, t.useState)(!1),
      [Ce, Fe] = (0, t.useState)(!1),
      [Se, we] = (0, t.useState)(!1),
      [Te, Ae] = (0, t.useState)(null),
      [ze, Ie] = (0, t.useState)(!1),
      ...
      Me = (e) => {
        ...
        Oe.current?.scrollTo({ x: t, animated: !1 });
      },
      He = (e) => {
        const t = e.nativeEvent.contentOffset.x;
        Re.current?.scrollTo({ x: t, animated: !1 });
      },
      Pe = (0, t.useMemo)(() => {
        const e = D,
          t = ee,
      ...
      Ve = (e) => {
        ...
        (L(e.id), H('detail'), S.impactAsync(S.ImpactFeedbackStyle.Light));
      },
      $e = (0, t.useMemo)(() => {
        const e = new Set(),
          t = new Date(),
          o = t.getMonth() + 1 >= 4 ? t.getFullYear() : t.getFullYear() - 1;
        (e.add(o),
      ...
      Ne = (0, t.useMemo)(() => {
        ...
        return (
          mySessions.forEach((t) => {
            t.tags && Array.isArray(t.tags) && t.tags.forEach((t) => e.add(t));
          }),
          Array.from(e).sort((e, t) => {
            const o = J.includes(e),
              n = J.includes(t);
        ...
        return (
          mySessions.forEach((t) => {
            const o = new Date(t.date),
              n = o.getFullYear(),
              l = o.getMonth() + 1;
            (l >= 4 ? n : n - 1) === ie && e.add(`${n}/${String(l).padStart(2, '0')}`);
          }),
          Array.from(e).sort((e, t) => e.localeCompare(t))
        );
      }, [mySessions, ie]);
    ((0, t.useEffect)(() => {
      $e.includes(ie) || le($e[0]);
    }, [$e, ie]),
      (0, t.useEffect)(() => {
        Ge.length > 0 ? Ge.includes(oe) || ne(Ge[Ge.length - 1]) : ne('');
      }, [Ge, oe]),
      (0, t.useEffect)(() => {
        if ('detail' === M && Pe && focusedMemberId) {
          const archersList = Ue(Pe.archers);
          const cellW = C.UIConfig.cellWidth * V;
      ...
      }, [M, Pe, focusedMemberId]));
    const Ye = (0, t.useMemo)(() => {
        let e = mySessions || [];
        return e
          .filter((e) => {
            if (!e) return !1;
            ...
            if (J.length > 0) {
              const t = e.tags || [];
              if ('AND' === K) {
                if (!J.every((e) => t.includes(e))) return !1;
              } else {
                if (!J.some((e) => t.includes(e))) return !1;
              }
            }
            if (!s) {
              if (a !== ie) return !1;
              if (`${n}/${String(l).padStart(2, '0')}` !== oe) return !1;
            }
            if (s) {
              const t = te.toLowerCase(),
                n = (e.title || '').toLowerCase().includes(t),
                l = (e.note || '').toLowerCase().includes(t),
                a =
                  `${o.getFullYear()}/${String(o.getMonth() + 1).padStart(2, '0')}/${String(o.getDate()).padStart(2, '0')}`.includes(
                    t
                  ),
                s = e.archers || [],
                d = (Array.isArray(s) ? s : 'object' == typeof s ? Object.values(s) : []).some((e) =>
    ...
    const qe = () => {
        ...
        const t = new Date(Pe.date),
          l = `${t.getFullYear()}/${String(t.getMonth() + 1).padStart(2, '0')}/${String(t.getDate()).padStart(2, '0')}`,
          a = Pe.shotCount || 8,
          d = Ue(Pe.archers).map((e) =>
            Object.assign({}, e, {
          ...
          c = (e) => {
            ...
            -1 !== t &&
              ('prev' === e && t < Ye.length - 1
                ? L(Ye[t + 1].id)
                : 'next' === e && t > 0 && L(Ye[t - 1].id));
          };
        return (0, k.jsxs)(o.default, {
          style: E.detailContainer,
          children: [
            (0, k.jsxs)(o.default, {
              style: {
                flexDirection: 'row',
              ...
              children: [
                (0, k.jsxs)(f.default, {
                  ...
                  children: [
                    (0, k.jsx)(F.Ionicons, { name: 'chevron-back', size: 24, color: '#007AFF' }),
                    (0, k.jsx)(n.default, { style: { fontSize: 17, color: '#007AFF' }, children: '戻る' }),
                  ],
                }),
                (0, k.jsx)(n.default, {
                ...
                (0, k.jsxs)(o.default, {
                  ...
                  children: [
                    (0, k.jsx)(f.default, {
                      ...
                      children: (0, k.jsx)(F.Ionicons, { name: 'chevron-back', size: 24, color: '#007AFF' }),
                    }),
                    (0, k.jsx)(f.default, {
                      onPress: () => c('next'),
                      style: ({ hovered: e }) => [
            ...
            (0, k.jsxs)(o.default, {
              ...
              children: [
                ...
                !!Pe.title && (0, k.jsx)(n.default, { style: E.detailTitle, children: Pe.title }),
                !!Pe.note &&
                  (0, k.jsx)(o.default, {
                    style: {
                      marginTop: 8,
                    ...
                    children: (0, k.jsx)(n.default, {
                      style: { fontSize: 13, color: '#3C3C43' },
                      children: Pe.note,
                    }),
                  }),
              ],
            ...
            (0, k.jsx)(o.default, {
              ...
              children: (0, k.jsxs)(o.default, {
                ...
                children: [
                    ...
                    children: (0, k.jsxs)(o.default, {
                      ...
                      children: [
                        (0, k.jsx)(o.default, {
                          ...
                          children: (0, k.jsx)(j.LabelColumn, { shots: a, showFooter: !1 }),
                        }),
                        (0, k.jsx)(u.default, {
                          horizontal: !0,
                  ...
                  (0, k.jsxs)(o.default, {
                    style: {
                      height: C.UIConfig.footerHeight * V,
                    ...
                    children: [
                      (0, k.jsx)(o.default, {
                        style: {
                          width: C.UIConfig.headerWidth * V,
                          ...
                          children: d.map((t, l) => {
                            return (0, k.jsx)(
                              o.default,
                              {
                                style: {
                                  width:
                                    (t.isSeparator ? C.UIConfig.separatorWidth : C.UIConfig.cellWidth) * V,
                                  height: C.UIConfig.footerHeight * V,
                                  ...
                                  (0, k.jsxs)(s.default, {
                                    ...
                                    children: [
                                      (0, k.jsx)(n.default, {
                                        ...
                                        numberOfLines: 2,
                                        children: t.isTotalCalculator
                                          ? '合計'
                                          : t.name
                                            ? ((a = t.name), (0, I.formatMemberName)(a, e || []))
                                            : '選択',
                                      }),
                                      t.isGuest
                                        ? (0, k.jsx)(n.default, {
                                            style: { fontSize: 9 * V, color: '#3C3C43', marginTop: 2 },
                                            children: '(ゲスト)',
                                          })
                                        : null,
                                      t.isTotalCalculator || '' === t.name
                                        ? null
                                        : (0, k.jsx)(o.default, {
                                            style: {
                                              marginTop: 2,
                              ...
                              typeof t.id === 'string' ? `footer-${t.id}` : `footer-${l}`
                            );
                            var a;
                          }),
                        }),
      ...
      Je = ({ item: e }) => {
        const t = new Date(e.date),
          l = `${t.getFullYear()}/${String(t.getMonth() + 1).padStart(2, '0')}/${String(t.getDate()).padStart(2, '0')}`,
          a = Ue(e.archers).filter((e) => !e.isSeparator && !e.isTotalCalculator).length,
          s = ue.has(e.id);
          ...
          children: [
            ...
            (0, k.jsxs)(o.default, {
              ...
              children: [
                (0, k.jsxs)(o.default, {
                  style: E.titleRow,
                  children: [
                    (0, k.jsx)(n.default, { style: E.itemDateText, children: l }),
                    !!e.title &&
                      (0, k.jsxs)(n.default, { style: E.itemTitleText, children: [' [', e.title, ']'] }),
                    (0, k.jsx)(F.Ionicons, {
                      name: '未同期' === e.syncStatus ? 'cloud-upload-outline' : 'cloud-done-outline',
                      size: 14,
                      color: '未同期' === e.syncStatus ? '#FF9500' : '#007AFF',
                      style: { marginLeft: 6 },
                    }),
                    !e.includeInStats &&
                      (0, k.jsx)(o.default, {
                ...
                e.tags &&
                  e.tags.length > 0 &&
                  (0, k.jsx)(o.default, {
                    style: E.itemTagsContainer,
                    children: e.tags.map((t, i) =>
                      (0, k.jsx)(
                        o.default,
                        {
                          style: E.itemTagChip,
                          children: (0, k.jsx)(n.default, {
                            style: E.itemTagText,
                            children: typeof t == 'string' ? t.replace(/^#/, '') : String(t),
                          }),
                        },
                        typeof t == 'string' ? `tag-${t}-${i}` : `tag-obj-${i}`
                      )
                    ),
                  }),
              ],
            ...
            (0, k.jsxs)(o.default, {
              ...
              children: [
                (0, k.jsx)(o.default, {
                  style: E.countBadge,
                  children: (0, k.jsxs)(n.default, { style: E.countBadgeText, children: [a, '人'] }),
                }),
                !de && (0, k.jsx)(F.Ionicons, { name: 'chevron-forward', size: 18, color: '#C7C7CC' }),
              ],
            }),
          ],
        });
      ...
      Qe = () => {
        de ? (ce(!1), he(new Set())) : (ce(!0), he(new Set()));
      },
      Xe = () => {
        0 !== ue.size && we(!0);
      },
      ...
      rt = (e, t) => {
        ...
        const o = Pe.archers.map((o) =>
          o.id === e
            ? Object.assign({}, o, { name: t, isGuest: !0, gender: '未設定', grade: 0, memberId: void 0 })
            : o
        );
        U(Pe.id, { archers: o });
      },
      ot = (e) => {
        ...
        const t = Pe.archers.map((t) =>
          t.id === e
            ? Object.assign({}, t, { name: '', memberId: void 0, isGuest: !1, gender: '未設定', grade: 0 })
            : t
        );
        U(Pe.id, { archers: t });
      },
          ...
          children: [
            'detail' === M
              ...
              : (0, k.jsxs)(o.default, {
                  ...
                  children: [
                    (0, k.jsxs)(o.default, {
                      style: E.listHeaderArea,
                      children: [
                        R &&
                          (0, k.jsx)(s.default, {
                            onPress: () => O(!1),
                            style: E.adminDeactivate,
                            children: (0, k.jsx)(n.default, {
                              style: E.adminDeactivateText,
                              children: '(管理者モード解除)',
                            }),
                          }),
                        (0, k.jsxs)(o.default, {
                    ...
                    de &&
                      ue.size > 0 &&
                      (0, k.jsxs)(s.default, {
                        style: E.batchDeleteBar,
                        onPress: Xe,
                        children: [
                          (0, k.jsx)(F.Ionicons, { name: 'trash', size: 18, color: '#FFF' }),
                          (0, k.jsxs)(n.default, {
                            style: E.batchDeleteText,
                            children: [ue.size, '件を削除'],
                          }),
                        ],
                      }),
                    (0, k.jsx)(o.default, {
                      ...
                      (0, k.jsxs)(o.default, {
                        ...
                        children: [
                          (0, k.jsxs)(o.default, {
                            ...
                            children: [
                              (0, k.jsx)(n.default, {
                                style: { fontSize: 13, fontWeight: 'bold', color: '#8E8E93' },
                                children: 'タグフィルター',
                              }),
                              (0, k.jsxs)(o.default, {
                                style: {
                                ...
                                children: [
                                  (0, k.jsx)(s.default, {
                                    ...
                                    style: [
                                      ...
                                      'AND' === K && { backgroundColor: '#FFF' },
                                    ],
                                    children: (0, k.jsx)(n.default, {
                                      style: {
                                        fontSize: 11,
                                        fontWeight: 'bold',
                                        color: 'AND' === K ? '#007AFF' : '#8E8E93',
                                      },
                                      children: 'すべて含む',
                                    }),
                                  }),
                                  (0, k.jsx)(s.default, {
                                    ...
                                    style: [
                                      { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6 },
                                      'OR' === K && { backgroundColor: '#FFF' },
                                    ],
                                    children: (0, k.jsx)(n.default, {
                                      style: {
                                        fontSize: 11,
                                        fontWeight: 'bold',
                                        color: 'OR' === K ? '#007AFF' : '#8E8E93',
                                      },
                                      children: 'いずれか含む',
                                    }),
                                  }),
                          ...
                          (0, k.jsxs)(u.default, {
                            ...
                            children: [
                              (0, k.jsx)(f.default, {
                                style: ({ hovered: e }) => [
                                  E.tagChip,
                                  0 === J.length && E.tagChipActive,
                                  { backgroundColor: 0 === J.length ? '#007AFF' : '#E5E5EA' },
                                  e && 0 !== J.length && { backgroundColor: '#D1D1D6' },
                                ],
                                onPress: () => Q([]),
                                children: (0, k.jsx)(n.default, {
                                  style: [E.tagChipText, 0 === J.length && { color: '#FFF' }],
                                  children: 'すべて解除',
                                }),
                              }),
                              Ne.map((e, idx) => {
                                ...
                                return (0, k.jsx)(
                                  f.default,
                                  {
                                    ...
                                    onPress: () => X(e),
                                    children: (0, k.jsx)(n.default, {
                                      style: [E.tagChipText, t && { color: '#FFF' }],
                                      children:
                    ...
                    !te &&
                      (0, k.jsxs)(k.Fragment, {
                        children: [
                          (0, k.jsx)(o.default, {
                            style: E.yearSelectorContainer,
                            children: (0, k.jsxs)(f.default, {
                              style: ({ hovered: e }) => [
                                E.yearButton,
                              ...
                              return (0, k.jsx)(
                                f.default,
                                {
                                  ...
                                  children: (0, k.jsxs)(n.default, {
                                    style: [E.monthTabText, t && E.monthTabTextActive],
                                    children: [e.split('/')[1], '月'],
                                  }),
                                },
                                e
                              );
                    ...
                    !!te &&
                      (0, k.jsx)(o.default, {
                        ...
                        children: (0, k.jsxs)(n.default, {
                          ...
                          children: ['「', te, '」の全期間検索結果: ', Ye.length, '件'],
                        }),
                      }),
                    (0, k.jsx)(a.default, {
                      data: Ye,
                      ...
                      ListEmptyComponent: (0, k.jsx)(n.default, {
                        style: E.emptyText,
                        children: '記録がありません',
                      }),
                    }),
            ...
            (0, k.jsx)(c.default, {
              ...
              children: (0, k.jsx)(s.default, {
                style: E.modalOverlay,
                activeOpacity: 1,
                onPress: () => se(!1),
                children: (0, k.jsxs)(o.default, {
                  style: E.yearModal,
                  children: [
                    (0, k.jsx)(n.default, { style: E.yearModalTitle, children: '年度を選択' }),
                    $e.map((e) =>
                      (0, k.jsx)(
                        s.default,
                        {
                          ...
                          children: (0, k.jsxs)(n.default, {
                            style: [E.yearOptionText, ie === e && E.yearOptionTextSelected],
                            children: [e, '年度 (', e, '/04 - ', e + 1, '/03)'],
                          }),
                        },
                        e
                      )
                    ...
                    (0, k.jsxs)(o.default, {
                      ...
                      children: [
                        (0, k.jsx)(s.default, {
                          ...
                          children: (0, k.jsx)(n.default, {
                            style: { fontSize: 16, color: '#007AFF', fontWeight: '500' },
                            children: me ? '完了' : '編集',
                          }),
                        }),
                        me
                              ...
                              children: [
                                (0, k.jsx)(s.default, {
                                  ...
                                  children: (0, k.jsx)(n.default, {
                                    style: {
                                      fontSize: 16,
                                      color: W.length > 0 ? '#FF3B30' : '#C6C6C8',
                                      fontWeight: '500',
                                    },
                                    children: 'すべて削除',
                                  }),
                      ...
                      children: (0, k.jsx)(o.default, {
                        ...
                        children: (0, k.jsx)(a.default, {
                          ...
                          ItemSeparatorComponent: () =>
                            (0, k.jsx)(o.default, {
                              style: { height: l.default.hairlineWidth, backgroundColor: '#E5E5EA' },
                            }),
                          ListEmptyComponent: (0, k.jsx)(n.default, {
                            style: {
                              textAlign: 'center',
                                ...
                                (0, k.jsxs)(o.default, {
                                  ...
                                  children: [
                                    (0, k.jsxs)(n.default, {
                                      ...
                                      children: [l, ' ', e.title ? `[${e.title}]` : ''],
                                    }),
                                    !!e.note &&
                                      (0, k.jsx)(n.default, {
                                        style: { fontSize: 12, color: '#000', marginTop: 4 },
                                        numberOfLines: 1,
                                        children: e.note,
                                      }),
                                  ],
            ...
            (0, k.jsx)(c.default, {
              ...
              animationType: 'fade',
              children: (0, k.jsx)(o.default, {
                style: E.confirmOverlay,
                children: (0, k.jsxs)(o.default, {
                  style: E.confirmModal,
                  children: [
                    (0, k.jsx)(n.default, {
                      style: E.confirmTitle,
                      children: Te ? '記録を削除' : '選択した記録を削除',
                    }),
                    (0, k.jsx)(n.default, {
                      style: E.confirmMessage,
                      children: '選択した記録をゴミ箱に移動しますか？',
                    }),
                    (0, k.jsxs)(o.default, {
                      style: E.modalButtonsRow,
                      children: [
                        (0, k.jsx)(s.default, {
                        ...
                        (0, k.jsx)(s.default, {
                          ...
                          onPress: async () => {
                            (Te ? (N(Te), Ae(null), H('list')) : (_(Array.from(ue)), he(new Set()), ce(!1)),
                              we(!1));
                          },
                          children: (0, k.jsx)(n.default, {
            ...
            (0, k.jsx)(w.EditSessionModal, {
              visible: Ce,
              session: Pe,
              onClose: () => Fe(!1),
              onSave: (e) => U(Pe.id, e),
            }),
            (0, k.jsx)(T.ArcherActionModal, {
              visible: ze,
              archerId: ke || '',
              archerName: Pe?.archers?.find((e) => e.id === ke)?.name || '',
              archerOrigIdx: De,
              isSeparator: Pe?.archers?.find((e) => e.id === ke)?.isSeparator || !1,
              isTotalCalculator: Pe?.archers?.find((e) => e.id === ke)?.isTotalCalculator || !1,
              onClose: () => Ie(!1),
              onSubstitution: () => We(!0),
              ...
              onAddArcher: (e) => {
                if (!Pe) return;
                const t = (0, b.newArcher)(Pe.shotCount || 8),
                  o = [...Ue(Pe.archers)];
                (o.splice(e, 0, t), U(Pe.id, { archers: o }));
              },
              onAddSeparator: (e) => {
                if (!Pe) return;
                const t = (0, b.newSeparator)(),
                  o = [...Ue(Pe.archers)];
                (o.splice(e, 0, t), U(Pe.id, { archers: o }));
              },
              onAddTotal: (e) => {
                if (!Pe) return;
                const t = (0, b.newTotalCalculator)(Pe.shotCount || 8),
                  o = [...Ue(Pe.archers)];
                (o.splice(e, 0, t), U(Pe.id, { archers: o }));
              },
              existingArchers: Ue(Pe?.archers),
            }),
            (0, k.jsx)(A.ManualSubstitutionModal, { visible: Be, archerId: ke, onClose: () => We(!1) }),
          ],
        }
      )
    );
  ...
  E = l.default.create({
    ...
    separator: { height: l.default.hairlineWidth, backgroundColor: '#C6C6C8', marginLeft: 20 },
