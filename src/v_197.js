...
const a = (typeof id !== 'undefined' ? id : 197);
const m = module;
const _e2 = exports;
const d = (typeof dependencyMap !== 'undefined' ? dependencyMap : []);

"use strict";Object.defineProperty(_e2,'__esModule',{value:!0}),Object.defineProperty(_e2,"CustomProvider",{enumerable:!0,get:function(){return we}}),Object.defineProperty(_e2,"ReCaptchaEnterpriseProvider",{enumerable:!0,get:function(){return ke}}),Object.defineProperty(_e2,"ReCaptchaV3Provider",{enumerable:!0,get:function(){return ge}}),Object.defineProperty(_e2,"getLimitedUseToken",{enumerable:!0,get:function(){return _e}}),Object.defineProperty(_e2,"getToken",{enumerable:!0,get:function(){return ye}}),Object.defineProperty(_e2,"initializeAppCheck",{enumerable:!0,get:function(){return be}}),Object.defineProperty(_e2,"onTokenChanged",{enumerable:!0,get:function(){return Pe}}),Object.defineProperty(_e2,"setTokenAutoRefreshEnabled",{enumerable:!0,get:function(){return Ee}});var e=require("./FirebaseError_180"),t=require("./Component_181"),n=require("./CONSTANTS_182"),o=require("./h_183");
/**
   * @license
...
/**
   ...
   * limitations under the License.
   */
class v{constructor(e,t,n,o,s){if(this.operation=e,this.retryPolicy=t,this.getWaitDuration=n,this.lowerBound=o,this.upperBound=s,this.pending=null,this.nextErrorWaitInterval=o,o>s)throw new Error('Proactive refresh lower bound greater than upper bound!')}start(){this.nextErrorWaitInterval=this.lowerBound,this.process(!0).catch(()=>{})}stop(){this.pending&&(this.pending.reject('cancelled'),this.pending=null)}isRunning(){return!!this.pending}async process(e){this.stop();try{this.pending=new n.Deferred,await(t=this.getNextRun(e),new Promise(e=>{setTimeout(e,t)})),this.pending.resolve(),await this.pending.promise,this.pending=new n.Deferred,await this.operation(),this.pending.resolve(),await this.pending.promise,this.process(!0).catch(()=>{})}catch(e){this.retryPolicy(e)?this.process(!1).catch(()=>{}):this.stop()}var t;
/**
   * @license
   * Copyright 2020 Google LLC
   *
