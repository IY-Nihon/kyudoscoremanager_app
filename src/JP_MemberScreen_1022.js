...
const C = () => {
  ...
  return (0, y.jsxs)(u.default, {
    ...
    children: [
      ...
      (0, y.jsx)(CC.CustomCalendarModal, { visible: calVis, onClose: () => setCalVis(false), selectedDate: new Date(V + 'T12:00:00'), onSelectDate: (date) => { K(date.getFullYear() + '-' + String(date.getMonth() + 1).padStart(2, '0') + '-' + String(date.getDate()).padStart(2, '0')); } })
    ]
  });
}
...
const j = l.default.create({
  ...
  eqInput: { backgroundColor: '#FFF', borderWidth: 1, borderColor: '#E5E5EA', borderRadius: 8, padding: 8, fontSize: 15, height: 40 },
  ...
  eqWeightInputWrapper: { backgroundColor: '#FFF', borderWidth: 1, borderColor: '#E5E5EA', borderRadius: 8, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8, height: 40 },
