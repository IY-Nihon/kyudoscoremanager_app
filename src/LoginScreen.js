...
var t = require('react'),
  ...
  n = e(require('./KeyboardAvoidingView')),
  o = e(require('./ScrollView')),
  s = e(require('./alertBridge')),
  c = e(require('./Pressable')),
  u = e(require('./View')),
  h = e(require('./Text')),
  p = e(require('./StyleSheet')),
  f = e(require('./TextInput')),
  x = require('./useScoreStore'),
  y = require('./IS_WEB'),
  b = require('./db'),
  C = require('firebase/auth'),
  j = require('firebase/firestore'),
  w = require('@expo/vector-icons'),
