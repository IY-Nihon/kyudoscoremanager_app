...
var _xlsx = require('./excelExport'),
  themeMod = require('./theme'),
  l = e(require('react')),
  o = e(require('./View')),
  n = e(require('./Text')),
  a = e(require('./StyleSheet')),
  s = e(require('./ScrollView')),
  d = e(require('./TouchableOpacity')),
  c = e(require('./Switch')),
  u = e(require('./alertBridge')),
  f = e(require('./Modal')),
  m = e(require('./TextInput')),
  ...
  C = t(require('expo-file-system/legacy')),
  b = t(require('expo-sharing')),
  S = require('./fileSaver'),
  E = require('./db'),
  B = require('firebase/auth'),
  I = require('./shadowStyle'),
  T = require('./themedJsx'),
  _F = require('firebase/firestore'),
