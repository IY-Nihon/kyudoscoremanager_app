  ...
  (0, d.persist)(
    (t, s) => {
      ...
      return {
        ...
        /**
         * 立ち順を入れ替える。押した列を、画面で1つ右か左へ動かす。
         *
         * 記録表は右から左へ並ぶので、画面の「右」は並びの手前（大前寄り）、
         * 「左」は並びの奥（落寄り）。取り違えやすいので、ここは画面で見た
         * とおりの向きを受け取り、並びの向きへの読み替えはここだけで行う。
         *
