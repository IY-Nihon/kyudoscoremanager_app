...
// ─────────────────────────────────────────
const NOTICE_VERSION = "2026-08-04-01";
...
const NOTICE_ITEMS = [
  {
    ...
    boldPoints: true,
    points: [
      "各団体のデータに、その団体の方だけがアクセスできるようにしました。",
      "個人IDでログインされている方は、お手数ですが一度ログインし直してください。団体IDとパスワードでログインされている方は、これまでどおりご利用いただけます。",
      "記録や名簿がなくなることはありません。操作方法の変更もありません。",
    ],
  },
  {
    date: "2026/08/03",
