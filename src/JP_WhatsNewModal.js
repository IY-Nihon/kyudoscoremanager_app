...
// ─────────────────────────────────────────
const NOTICE_VERSION = '2026-08-18-03';
...
const NOTICE_ITEMS = [
  ...
  },
  {
    date: '2026/08/18',
    版: '2026-08-18-03',
    title: '途中交代を「立」でも入れられます',
    points: [
      '名前を押して「途中交代」を開くと、「立」と「射目」を選べるようになりました。開いたときは「立」です。',
      '「立」で2と入れれば、5射目からの交代になります。何射目からになるかは、決める前に画面へ出ます。',
    ],
  },
  {
    date: '2026/08/18',
