...
const NOTICE_ITEMS = [
  ...
  },
  {
    ...
    points: [
      '「同期エラーを通知」の切り替えをなくしました。切ったまま忘れて、何日も同期できていないことがあり得たためです。',
      '不具合が起きると、内容と直前の操作が自動で届きます。電波が無いときは端末に控え、つながったときに送ります。',
      '送るのは不具合の内容と操作の名前だけです。部員の氏名や的中は含みません（プライバシーポリシー第4条）。',
    ],
  },
  {
    date: '2026/08/28',
