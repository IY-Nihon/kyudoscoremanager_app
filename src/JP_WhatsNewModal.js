...
const NOTICE_ITEMS = [
  {
    date: '2026/08/13',
    title: 'ライブ記録の不具合を修正しました',
    boldPoints: true,
    points: [
      'ライブ記録に参加したとき、しばらく記録が表示されないことがある不具合を修正しました。',
      'ライブ記録中に「やり直し」が押せなくなっていた不具合を修正しました。',
      '取り消し・やり直しをしたときに、お知らせが二重に表示される問題を修正しました。',
    ],
  },
  {
    date: '2026/08/13',
    title: '',
    points: [
      '「終了・保存」したあとに「取り消し」を押すと、保存済みの記録が画面に戻り、そのまま保存すると同じ記録が二重に残ってしまう不具合を修正しました。',
      'ライブ記録の名前に「/」などが使えてしまい、その場合に誰も参加できないライブができてしまう不具合を修正しました。使えない文字を入力すると、その場でお知らせします。',
      'ライブ記録中に「リセット」したあと、「取り消し」で消したはずの記録が戻ってしまう不具合を修正しました。',
      'ライブ記録の参加一覧が、最終更新の新しい順に並ぶようになりました。長く使われていないものは自動で整理されます。',
      'ライブ記録の通信量を大幅に減らしました。参加一覧の読み込みが軽くなります。',
    ],
  },
  {
    date: '2026/08/06',
