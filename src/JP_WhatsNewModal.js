...
// ─────────────────────────────────────────
const NOTICE_VERSION = '2026-08-14-01';
...
const NOTICE_ITEMS = [
  {
    ...
    points: [
      '○×を入れて3秒たつと、そのますは薄い灰色になり、押しても変わらなくなります。記録中に手や袖が当たって、入れた○×が消えてしまうのを防ぐためです。',
      '直したいときは、そのますを長押ししてください。そこだけ開きます。',
  ...
  },
  {
    ...
    points: [
      ...
      'ライブ記録の細かな不具合の修正や、通信量の削減など、その他諸々の修正を行いました。',
    ],
  },
  {
    date: '2026/08/06',
