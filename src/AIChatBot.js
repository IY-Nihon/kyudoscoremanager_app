...
const qaData = [
  ...
  {
    k: ['遅刻', '早退', '出欠', '変更'],
    t: 'Q2: 遅刻や早退の記録は？\nA: 記録タブの「終了・保存」ボタンを押すと出欠確認画面が表示され、各メンバーの出欠状態（出席・遅刻・早退・欠席等）を選択できます。後から修正する場合は、管理者モードで履歴詳細を開き「≡」メニュー→「記録の情報を変える」から変更できます。',
  },
  {
    k: ['正規', '練習日', 'カレンダー', '登録', '予定'],
  ...
  {
    k: ['まとめて', '一括', '複数', '出欠'],
    t: 'Q5: まとめて出欠を変更できる？\nA: 管理者モードをオンにした状態で履歴タブから記録を押して詳細画面を開き、画面右上の「≡」（ハンバーガー）メニューから「記録の情報を変える」を選ぶと各メンバーの出欠状態を変更できます。',
  },
  {
    k: ['人数', '制限', '立ち', '何人'],
  ...
  {
    k: ['復元', '戻す', '元に戻', 'ゴミ箱'],
    t: 'Q14: 間違えて消した記録は戻せる？\nA: 削除したデータは一度「ゴミ箱」に入り、そこから復元可能です。ゴミ箱の記録を押すと中身を見られます（見るだけで、直したり消したりはできません。上の帯の「復元」で戻せます）。ゴミ箱を空にすると完全削除されます。',
  },
  { k: ['出欠', '直せ', '修正'], t: 'Q15: 過去の出欠も直せる？\nA: 管理者モードであれば修正可能です。' },
  {
    k: ['全体的中率', '履歴', '表示'],
    t: 'Q16: 履歴に表示される「全体的中率」とは？\nA: 履歴一覧には参加人数と矢数が表示されます。的中率は各詳細または分析タブで確認します。',
  },
  {
    k: ['オフライン', '通信', '圏外', '見れ'],
  ...
  {
    k: ['ランキング', '順位', '一番'],
    t: 'Q30: 誰が一番中っているかランキングはある？\nA: 分析タブの下部に、メンバー別の的中率ランキング（成績一覧）が表示されます。',
  },
  {
    k: ['追加', '新入', '登録', '入部', 'まとめて', '複数', '何人'],
